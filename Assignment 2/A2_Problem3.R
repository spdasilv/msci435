...
LB1 = z.SP1 - 3000000*u1 - 2000000*u2
...
mySP2$sense = c(">=",">=",">=")
mySP2$rhs = c(600000,400000,800000)
mySP2$vtypes = "I"
...
LB2 = z.SP2 - 3000000*u1 - 2000000*u2
...
mySP3$sense = c(">=",">=",">=")
mySP3$rhs = c(900000,300000,500000)
mySP3$vtypes = "I"
...
LB3 = z.SP3 - 3000000*u1 - 2000000*u2
